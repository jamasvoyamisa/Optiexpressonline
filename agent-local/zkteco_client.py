...
class ZKTecoClient:
    ...
    def set_user(self, user_id: str, name: str, uid: Optional[int] = None) -> bool:
        ...
        user_id: numero de empleado (PIN)
    ...
    def delete_user(self, user_id: str) -> bool:
        """Elimina un usuario del dispositivo por su user_id (numero de empleado)."""
        conn = None
        user_id = str(user_id or "").strip()
        if not user_id:
    ...
    def enroll_user(self, user_id: str, finger_index: int = 0, timeout_seconds: int = 60) -> bool:
        ...
        user_id: numero de empleado (debe existir en el dispositivo)
