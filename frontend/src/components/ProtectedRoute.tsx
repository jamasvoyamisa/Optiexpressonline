...
/** Permisos requeridos por ruta: superuser (solo admin), rh (RH o admin), dashboard, mi_area, solicitudes_vacaciones (Admin/Director/GG), o all (cualquier autenticado). */
export type RoutePermission = 'superuser' | 'rh' | 'dashboard' | 'mi_area' | 'solicitudes_vacaciones' | 'all';
