#!/usr/bin/env python3
"""
Interfaz grafica para el Agente Windows Multi-Dispositivo ZKTeco.
...
class AgentGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("Agente Windows Multi-Dispositivo - ZKTeco")
    ...
    def _build_ui(self):
        ...
        ttk.Label(main, text="Agente Windows Multi-Dispositivo", style="Title.TLabel").pack(anchor="w", pady=(0, 8))
